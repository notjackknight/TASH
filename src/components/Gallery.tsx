...
const imageSources: ImageSource[] = [
  { type: 'image', src: '/eh_public_assets/gallery/gallery17.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-2 col-span-2' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery18.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-2' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery19.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-1' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery20.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-1' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery21.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-2 col-span-2' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery22.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-1' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery23.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-1' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery24.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-2' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery25.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-2 col-span-2' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery26.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-1' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery27.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-1' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery28.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-2' },
  { type: 'image', src: '/eh_public_assets/gallery/gallery29.webp', alt: 'TASH Skin, in frames', mobileSpan: 'row-span-1 col-span-2' },
  ...
  { type: 'image', src: '/eh_public_assets/gallery/gallery14.webp', alt: 'TASH Skin moment',      mobileSpan: 'row-span-1 col-span-1' },
  ...
  { type: 'image', src: '/eh_public_assets/gallery/gallery12.webp', alt: 'Ambient studio',         mobileSpan: 'row-span-1 col-span-2' },
