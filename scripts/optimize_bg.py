...
JOBS: list[tuple[str, str, str]] = [
    ...
    ("photo", "Packages/HP_BG_New.jpg",                "Packages/HP_BG_New.webp"),
    ("photo", "Packages/HP_BG_mobile.jpg",             "Packages/HP_BG_mobile.webp"),
    ("photo", "Packages/Brow_Lash_Combo.png",          "Packages/Brow_Lash_Combo.webp"),
    ("photo", "Packages/The_Bridal_Experience.png",          "Packages/The_Bridal_Experience.webp"),
    ("photo", "Packages/The_New_Mommy_Reset_Glow_Package.png", "Packages/The_New_Mommy_Reset_Glow_Package.webp"),
    ("photo", "Packages/The_Baby_Bump_Package.png",          "Packages/The_Baby_Bump_Package.webp"),
    ("photo", "Packages/The_Molecular_Peel_Package.png",     "Packages/The_Molecular_Peel_Package.webp"),
    ("photo", "Packages/The_Blemish+Breakout_Package.png",   "Packages/The_Blemish+Breakout_Package.webp"),
